...
`dotspacemacs/user-config' first."
  ...
  (setq-default rspec-spec-command "bundle exec rspec")
  (setq-default rspec-autosave-buffer t)
  (setq-default rspec-expose-dsl-globally t)
