...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(graphql-mode vue-mode)
...
(custom-set-variables
 ...
 '(ruby-encoding-magic-comment-style (quote custom))
